  ...
  const renderStartSession = () => (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200">
      <div className="px-6 py-4 border-b border-gray-200">
        <h2 className="text-lg font-medium text-gray-900">Start New Speaking Session</h2>
      </div>
      ...
      <div className="p-6 space-y-4">
        <div>
          ...
          <input
            ...
            placeholder="e.g., My daily routine, Travel experiences, Future plans..."
          />
        </div>

        <div>
          <label htmlFor="speakTime" className="block text-sm font-medium text-gray-700 mb-1">
