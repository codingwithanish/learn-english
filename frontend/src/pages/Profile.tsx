      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          ...
          <div className="px-4 sm:px-6 py-4 border-b border-gray-200 flex items-center justify-between">
            <h1 className="text-lg sm:text-xl font-medium text-gray-900">Profile Settings</h1>
            {!isEditing && (
              <button
          ...
          <div className="px-4 sm:px-6 py-6 border-b border-gray-200">
            <div className="flex items-center">
              ...
              <div className="ml-4 min-w-0 flex-1">
                <h2 className="text-base sm:text-lg font-medium text-gray-900 truncate">{user?.name}</h2>
            ...
            <div className="grid grid-cols-1 gap-6">
              <div>
                ...
                <input
                  ...
                  disabled={!isEditing}
                  className="mt-1 block w-full px-4 py-3 sm:px-3 sm:py-2 text-base sm:text-sm border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 disabled:bg-gray-50 disabled:text-gray-500"
                />
              </div>
            ...
            {isEditing && (
              <div className="mt-6 flex flex-col sm:flex-row justify-end gap-3 sm:space-x-3">
                <button
                  ...
                  className="w-full sm:w-auto px-4 py-3 sm:py-2 border border-gray-300 rounded-md shadow-sm text-base sm:text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 order-2 sm:order-1"
                >
                  Cancel
                </button>
                <button
                  onClick={handleSave}
                  className="w-full sm:w-auto px-4 py-3 sm:py-2 border border-transparent rounded-md shadow-sm text-base sm:text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 order-1 sm:order-2"
                >
                  Save Changes
                </button>
              </div>
