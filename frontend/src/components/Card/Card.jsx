...
const Card = ({ 
  ...
  const type = details.type || resource.type;
  const content = details.content || resource.content || resource.query;
  const description = details.description || resource.description;
  const rating = details.rating || resource.rating || 0;
  const impressions = details.impressions || resource.impressions || 0;
  const examples = details.examples || resource.examples || [];
  const isFavorite = details.is_favorite || resource.is_favorite || false;
